...
Gem::Specification.new do |s|
  s.name = %q{progress_upload_field}
  s.version = "0.0.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Andi Altendorfer"]
  s.date = %q{2011-08-18}
  s.description = %q{use 'progress_upload_field' in your view, next your file_field}
  ...
  s.homepage = %q{http://github.com/iboard/progress_upload_field}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{FormHelper to display div-tags and a javascript to show a progress-bar while uploading files}
